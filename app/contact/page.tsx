                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">nayastack8810@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">7835649916, 8810524651</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">H.no. 653 Gram Sabha Pooth Kalan Rohini Sector-23 Delhi</p>
                    </div>
                  </div>
                  <div>
